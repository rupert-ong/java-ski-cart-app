    ...
    <div class="container">
        ...
        <form action="shop.jsp" method="post">
            ...
            <table class="table">
                <tr>
                 ...
                 <c:forEach var="item" items="${items}">
                    <tr>
                        <td><input type="number" name="num-${ind}" id="num-${ind}" class="form-control" value="${item.qty}" min="0" max="99" step="1" readonly></td>
            ...
            <table class="table">
                ...
                <tr>
                    <p><strong>An email confirmation will be sent.</strong></p>
                </tr>
            </table>
            <ul class="list-inline">
                <li><input type="submit" class="btn btn-primary" value="Place Order"></li>
            </ul>
        </form>
    </div>
